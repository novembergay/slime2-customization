...
extension home page: https://slime2.stream/
general installation guide: https://forums.slime2.stream/resources/widget-setup.3/

Steps for installing a custom font will be applicable for "Flexible Bubble Chat" widget (https://forums.slime2.stream/resources/flexible-bubble-chat.22/) but should apply for other Slime2 chat widgets if a different one is used.
...
Prep Steps:
1. Download Slime2 chat widget
2. Place downloaded widget wherever you store your in-use OBS assets
3. Configure widget _outside of OBS_ by following the general setup instructions: https://forums.slime2.stream/resources/widget-setup.3/
4. Download the custom font you want to use
5. Confirm the Slime2 widget works correctly as a Browser Source in OBS
...
- `font-style` is "normal" since this was a non-italic font. if you want to also specify a seperate italic font, you can add another identical block referencing a different font file, with the same `font-family` value, with `font-style`: italic;
END NOTES;
